...
//                "http://localhost:8084/abnml/getwithreq2?user={userId}&age={age}"
//                , headers
...
//                RestTemplateTool.getInstance().getWithRequestBodyForObject("http://localhost:8084/abnml/getwithreq2?user=userId&age=14", reqBody, "UTF-8");
