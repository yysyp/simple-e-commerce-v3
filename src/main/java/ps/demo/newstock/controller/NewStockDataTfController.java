...
public class NewStockDataTfController extends BaseController {
    ...
    public ModelAndView save(NewStockDataReq newStockDataReq, HttpServletRequest request) {
        ...
        MapperTool.copyProperties(newStockDataReq, newStockDataDto);
    ...
    public ModelAndView query(Model model) {
        ...
        BasePageResData<NewStockDataDto> myPageResData = new BasePageResData<>(newStockDataDtoPage,
